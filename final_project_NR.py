...
# %%
# trivial classifier that predicts the mode (6 for white records, 5 for red) for all records -- this will serve as baseline for performance
...
# print('Perceptron')
# model = PCT(random_state=0, n_jobs=-1)
# oneVsRestAnalysis(model, white_train_x, white_train_y, white_test_x, white_test_y, white_labels)

# from sklearn.linear_model import SGDClassifier as SGD
# print('SGDClassifier')
# model = SGD(random_state=0, n_jobs=-1, penalty='elasticnet')
# oneVsRestAnalysis(model, white_train_x, white_train_y, white_test_x, white_test_y, white_labels)

################### logistic and ridge regression perform the best out of the four ###################
